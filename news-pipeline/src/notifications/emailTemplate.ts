          ...
          <tr>
            <td style="padding: 20px 30px; background-color: #f8fafc; border-top: 1px solid #e2e8f0; text-align: center;">
              <p style="margin: 0 0 8px 0; font-size: 12px; color: #64748b;">
                Recibiste esta notificación porque estás suscrito a la categoría <strong>${categoryName}</strong> en TODOMIGOB.
              </p>
              <p style="margin: 0; font-size: 11px; color: #94a3b8;">
                TODOMIGOB · Este es un sitio oficial del gobierno
              </p>
            </td>
          </tr>
...
export function renderNewsText(userName: string, news: NewsItem): string {
  ...
  let text = `TODOMIGOB - ${categoryName.toUpperCase()}\n`;
  text += `${"=".repeat(40)}\n\n`;
